...
export const Default: React.FC = () => {
  ...
  return (
    <>
      ...
      <Row>
        <ButtonMenu activeIndex={index1} onItemClick={handleClick1} scale="sm" variant="gradient" ml="24px">
          <ButtonMenuItem>Button 1</ButtonMenuItem>
          <ButtonMenuItem>Button 2</ButtonMenuItem>
          <ButtonMenuItem>Button 3</ButtonMenuItem>
          <ButtonMenuItem>Button 4</ButtonMenuItem>
  ...
  return (
    <Row>
      <ButtonMenu activeIndex={0}>
        <ButtonMenuItem as="a" href="#1">
          Link 1
        </ButtonMenuItem>
        <ButtonMenuItem as="a" href="#2">
          Link 2
        </ButtonMenuItem>
        <ButtonMenuItem as="a" href="#3">
          Link 3
        </ButtonMenuItem>
      </ButtonMenu>
    </Row>
